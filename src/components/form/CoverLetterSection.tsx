      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: string | boolean | File | null) => handleChange("referralSource", value)}
          >
            <SelectTrigger
              id="referralSource"
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: string | boolean | File | null) => handleChange("salaryRange", value)}
          >
