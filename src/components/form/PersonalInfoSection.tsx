      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: string | boolean | File | null) => handleChange("phone", value)}
          >
            <SelectTrigger
              id="phone"
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: string | boolean | File | null) => handleChange("position", value)}
          >
            <SelectTrigger
              id="position"
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: string | boolean | File | null) => handleChange("experienceLevel", value)}
          >
            <SelectTrigger
              id="experienceLevel"
